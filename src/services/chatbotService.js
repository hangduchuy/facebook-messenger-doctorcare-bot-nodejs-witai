...
const IMAGE_GET_STARTED = 'https://lh3.googleusercontent.com/u/0/drive-viewer/AK7aPaB7Fa3qn4UHxrfNgchzhxkEbz6_x3ekGqhCllNIMQvm4hA6DZAiZeRwYNBU7XMOxRVlL6nw9FDyMjSNsVhFGq5-DUVe=w1366-h619';
const IMAGE_GET_BOOKING = 'https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExbnptOTNybnJ0bTJ3bzE4NTR3ZHljaXVwZ2hqcXFidzZlamZ1b2cxMiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/mWrFWSdUpwlMvbC59G/giphy.gif';
const IMAGE_CHANGE_BOOKING = 'https://media.tenor.co/9D8Fi0egkJoAAAAC/arzt-ueberlegen.gif?t=AAYGuuuhhHoKSnGYPQQ1aQ&c=VjFfZmFjZWJvb2s&itemid=11428885';
...
let handleGetStarted = (sender_psid) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            let response1 = { "text": `Xin chào ${username}! Tôi là trợ lý ảo của DoctorCare. Tôi có thể giúp gì cho bạn hôm nay?` }
...
let getSpecialtyTemplate = () => {
    let response = {
        "text": "Để khám chuyên khoa, vui lòng chọn chuyên khoa theo đường dẫn: https://doctorcare-frontend-reactjs-934629264119.herokuapp.com/getall-specialty/"
    }
...
let getDoctorTemplate = () => {
    let response = {
        "text": "Để khám bác sĩ, vui lòng chọn bác sĩ theo đường dẫn: https://doctorcare-frontend-reactjs-934629264119.herokuapp.com/getall-doctor/"
    }
...
let getChangeScheduleResTemplate = () => {
    let response = {
        "text": "Nếu bạn muốn thay đổi lịch khám, vui lòng đặt lại lịch khám trên website: https://doctorcare-frontend-reactjs-934629264119.herokuapp.com/"
    }
    return response;
}
...
let getFootTemplate = () => {
    let response = {
        "text": `Bạn đang gặp vấn đề về cơ xương khớp, xem thêm danh sách bác sĩ chuyên khoa CƠ XƯƠNG KHỚP: https://doctorcare-frontend-reactjs-934629264119.herokuapp.com/detail-specialty/2`
    }
...
let handleSendHead = (sender_psid) => {
    return new Promise(async (resolve, reject) => {
        try {
            let response = {
                "text": `Bạn đang gặp vấn đề về thần kinh, xem thêm danh sách bác sĩ chuyên khoa THẦN KINH: https://doctorcare-frontend-reactjs-934629264119.herokuapp.com/detail-specialty/3`
            };
...
let handleSendBelly = (sender_psid) => {
    return new Promise(async (resolve, reject) => {
        try {
            let response = {
                "text": `Bạn đang gặp vấn đề về tiêu hóa, xem thêm danh sách bác sĩ chuyên khoa TIÊU HÓA: https://doctorcare-frontend-reactjs-934629264119.herokuapp.com/detail-specialty/4`
            };
